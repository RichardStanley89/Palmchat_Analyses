...
For the sake of certainty, for now, let's just remove these observations. Unfortunately, for the corales data, some of the ones we are removing also show as group interactions, so I don't know if there is a way we can keep that data. 

```{r}
# We get 652 observations here
