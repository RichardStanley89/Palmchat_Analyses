...
Behavior_Data <- read.csv("../processed_data/Behavior_data.csv")
...
data <- Behavior_Data %>% group_by(Behavior_Data$Observation.id) %>%
  summarise(length= length(Behavior_Data$Behavior))

# Videos are a random effect (video idea) GLMMs

# fixed: things you think think are actually impacting the behavior (your hypotheses)
...
#### Calculate duration of Camera recordings by year...
